...
No laboratório BX, Vercel/Railway, PostgreSQL, Cloudflare R2, Sentry, Better Stack e OpenTelemetry estão operacionais. Backup com heartbeat, worker de eventos, limpeza de sessões e traces externos foram comprovados. Em 03/09/2026, um drill controlado também validou detecção, alerta por e-mail, reconhecimento, diagnóstico e recuperação automática de incidente sem interromper o serviço real. O recorte técnico da BX.4 possível sem conta corporativa está concluído e a BX.5 começou com CI/CD integralmente verde, Sonar aprovado e Dependabot sem alertas; Resend, retry/bounce e canais corporativos permanecem bloqueados até existir domínio/e-mail corporativo. Esse estado não constitui staging ou produção e não autoriza dados reais; bloqueios vigentes estão em [Problemas postergados](docs/PROBLEMAS_POSTERGADOS.md).
