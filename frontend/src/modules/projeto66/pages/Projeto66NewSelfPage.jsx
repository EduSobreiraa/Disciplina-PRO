...
function saveButtonLabel(key, saving, saveError, defaultLabel) {
  if (saving === key) return 'Salvando…'
  return saveError === key ? 'Tentar novamente' : defaultLabel
}
