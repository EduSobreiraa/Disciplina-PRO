...
export function Projeto66NewSelfPage() {
  ...
  function saveCheckin() { projeto66PrivateLocalRepository.saveNewSelfCheckin({ alignment, occurredAt: new Date().toISOString() }); setMessage('Check-in privado registrado.') }
