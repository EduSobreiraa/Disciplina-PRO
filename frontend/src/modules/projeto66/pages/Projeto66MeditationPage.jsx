...
function timerActionLabel(timer) {
  if (timer.running) return 'Pausar'
  return timer.complete ? 'Concluído' : 'Iniciar'
}

function saveActionLabel(saved, saving, saveError) {
  if (saved) return 'Meditação registrada'
  if (saving) return 'Salvando…'
  return saveError ? 'Tentar novamente' : 'Salvar no histórico privado'
}
