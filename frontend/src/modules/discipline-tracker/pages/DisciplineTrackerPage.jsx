...
import { getDateKeyInTimeZone } from '../../daily-ritual/repositories/daily-ritual.http.repository'
...
export function DisciplineTrackerPage() {
  ...
  const today = getDateKeyInTimeZone(timeZone, clock)
  ...
  async function mark(day, behavior) {
    if (getMarkKey(year, month, day, behavior.id).slice(0, 10) !== getDateKeyInTimeZone(timeZone)) return
