...
- **Problema:** o backup lógico diário, a restauração local e o monitoramento automático de falha do job estão comprovados, mas PITR, restore dentro do Railway e ensaio de rollback/forward-fix ainda não foram comprovados.
