...
| Fase 2 — backup diário (automação comprovada; restore pendente) | 06–07/09/2026 · staging privado corporativo | Railway `Backup_staging` · Cloudflare R2 `disciplina-pro-backups-staging/postgres/` | Eduardo | Serviço privado configurado a partir de `ops/backup/Dockerfile`, cron `0 2 * * *` UTC e política `NEVER`; presença das variáveis obrigatórias confirmada sem expor valores. A evidência visual do R2 preserva quatro pares distintos de `.dump` e `.sha256`, incluindo `disciplina-pro-20260906T153723Z`, `disciplina-pro-20260906T154828Z`, `disciplina-pro-20260906T155644Z` e `disciplina-pro-20260907T144252Z`; o último dump tinha aproximadamente 216 MB e seu checksum 103 B. O responsável confirmou o funcionamento automático. O histórico operacional anterior no Railway foi perdido durante a recriação do serviço, mas os artefatos persistentes permaneceram no bucket. | Agendamento, dump, checksum, upload, verificação e heartbeat estão comprovados. A automação de backup deixa de ser pendência do staging; permanece separado somente o ensaio formal de restore/recuperação e o aceite do RPO efetivo. |
