...
- [ ] Validar PITR no plano contratado e ensaiar corte manual em serviço Railway novo, com RPO/RTO aprovados. O dump diário não substitui o RPO de uma hora. Registrar o aceite formal pendente do PP-007; este item não bloqueia a beta controlada se o RPO efetivo for aceito conforme a diretriz de MVP.
