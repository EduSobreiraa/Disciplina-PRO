...
import { InvalidCeoReplacementError, InvalidTenantDataError, InvalidTenantTransitionError, PlatformActorInactiveError, TenantActiveCeoRequiredError, TenantNotFoundError, TenantSlugUnavailableError } from '../domain/organization.errors.js'
